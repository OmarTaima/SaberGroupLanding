...
1. Crawler requests `https://Saber Group-rs.com/projects/some-project`
...
```
❌ /projects/project-1 → "Saber Group - Premium Real Estate Development"
❌ /projects/project-2 → "Saber Group - Premium Real Estate Development"
❌ /about → "Saber Group - Premium Real Estate Development"
```

**After:** Each link shows its own unique preview

```
✅ /projects/project-1 → "Project Name 1 - Saber Group" with mainImage
✅ /projects/project-2 → "Project Name 2 - Saber Group" with mainImage
✅ /about → "About Us - Saber Group" with Saber Group logo
```
